...
/// Build a Grid from config, using autoGrid for any zero dimensions.
pub fn gridFromConfig(cfg: config.Config, recip: math.Mat3, volume: f64) Grid {
...
pub fn autoGrid(ecut_ry: f64, grid_scale: f64, recip: math.Mat3) [3]usize {
