...
const find_fermi_level_spin = fermi_level.find_fermi_level_spin;
const accumulate_kpoint_density_smearing_spin = kpoint.density.accumulate_kpoint_density_smearing_spin;
